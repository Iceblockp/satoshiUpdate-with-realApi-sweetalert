  ...
  return (
    <div className="bg-[rgb(23,32,51)] min-h-screen">
      ...
      <div className="w-full min-h-screen flex flex-col relative lg:fixed top-0 left-0 z-0 ps-0 lg:ps-[284px]">
        ...
        {/* midde  */}
        <div style={{ transform: `${draw ? 'translateY(-100%)': 'translateY(0)'}` }}  className={` duration-500 py-[8px] lg:block relative lg:fixed overflow-auto h-full w-full lg:w-[280px] top-0 left-0 z-20 bg-[rgb(23,32,51)] ${draw && 'hidden' } `}>
      ...
      {/* second Middle  */}
      <div  className={` py-[8px] lg:block relative lg:fixed overflow-auto h-full w-full lg:w-[280px] top-0 left-0 z-20 bg-[rgb(23,32,51)] hidden } `}>
        <div className=" px-[24px] ">
          {/* inBar  */}
          <div className=" py-[4px] mb-[20px] hidden lg:block ">
            <img
