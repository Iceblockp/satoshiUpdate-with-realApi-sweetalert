      ...
      <div className="w-full min-h-screen flex flex-col relative lg:fixed top-0 left-0 z-30 ps-0 lg:ps-[284px]">
        <div className="py-[12px] hidden lg:flex lg:justify-between ">
          ...
          <div className=" px-[24px] flex  items-center flex-grow justify-end gap-[1.5rem] ">
            ...
            <div onClick={aehandle} className="relative" >
              <img
              ...
              />
            {/* logout  */}
            <div className={` ${!ae && 'hidden'} absolute z-50 right-0  p-[8px] bg-white rounded-[20px] `}>
                <div className=" w-[174.66px] flex flex-col h-[348px] ">
                  <div className=" px-[16px] py-[8px] ">
                    <div className=" mb-[4px] text-gray-400 ">Signed in as</div>
                    <div className=" text-gray-700 ">Alexis Enache</div>
                  </div>

                  <hr />
                  <div className=" hover:bg-gray-100 flex items-center px-[16px] py-[8px] ">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                  ...
                  <div className=" hover:bg-gray-100 px-[16px] flex items-center py-[8px] ">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                  ...
                  <div className=" hover:bg-gray-100 px-[16px] py-[8px] flex items-center ">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
        ...
        <div className=" py-[8px] block lg:hidden ">
          <div className=" px-[16px] flex justify-between items-center ">
            ...
            <div className=" relative">
              <div onClick={aehandle} className=" flex items-center cursor-pointer ">
